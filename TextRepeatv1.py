...
def abt():
    try:
        os.startfile(os.path.join(path[0], 'about.pdf'))
    except FileNotFoundError:
        print("\nFile not found. It may be corrupt or deleted.")
        web = input("\nLook up the web?(y/n): ")
        if aliveconn() == 1:
            if web.lower() == 'y':
                webbrowser.open('https://github.com/1bl4z3r/Text_Repeat')
            elif web.lower() != 'n' and web.lower() != 'y':
                return None
